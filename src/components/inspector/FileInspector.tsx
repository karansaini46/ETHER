...
export function FileInspector() {
  ...
  return (
    <div className="technical-panel rounded shadow-technical p-5 font-mono text-xs text-secondary bg-surface-raised/95 border border-border-hairline h-full flex flex-col min-h-0 select-none">
      
      {/* Sticky Header */}
      <div className="flex justify-between items-center border-b border-primary/5 pb-2 mb-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-secondary/40 hover:text-danger transition-colors font-mono text-[9px] uppercase tracking-wider pr-2 border-r border-primary/5 mr-1"
            title="Deselect this node and clear highlights"
          >
            Clear
          </button>
          <button
      ...
      <div className="flex-1 overflow-y-auto hud-scrollbar pr-1 space-y-4">
        ...
        {/* Action Row */}
        <div className="space-y-2 pt-3 border-t border-primary/5 shrink-0">
